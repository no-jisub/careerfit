...
export default function LoginPage() {
  ...
  const moveToRoleHome = result => navigate(result.role ? (result.role === 'student' ? '/student' : '/dashboard') : '/account-status', { replace: true });
